...
public class LsFindTable 
{
	private String fname = "ls_path.txt";
	private String fname2 = "ls_path.txt";
	...
	public static LsFindTable lsfind= null;
...
// 2013-04-06;
	...
	//public int AddPath(String name, String path)
	...
	public void Save()
	{
		...
		try {
			...
			//JOptionPane.showMessageDialog(null, "workdir="+workdir);
			// iterator fmap;
			String str;
			String s;
			Iterator<String> iterator = fmap.keySet().iterator();                
